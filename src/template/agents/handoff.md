...
Si no hay ninguna tarea en curso, este archivo debe decir explícitamente "Sin tarea en curso" en vez de quedar con el contenido de la última tarea ya cerrada.
...
<!-- Si la tarea ameritó plan (según rules.md), va acá: los pasos acordados con el operador, marcando en cuál se está parado, y el modo de ejecución acordado (todos seguidos sin pausa vs. uno a la vez con confirmación). Si la tarea fue chica y se ejecutó directo, esta sección no aplica: borrarla o dejarla en "No aplica". -->
