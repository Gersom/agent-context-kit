...
- **Bloqueos:** qué tiene que pasar antes de poder empezarla — ej. que termine otra tarea de este backlog (linkear su título), o una dependencia externa. "Ninguno" si no aplica.
